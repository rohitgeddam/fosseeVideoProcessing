...
class Chunk(models.Model):
    operationId = models.ForeignKey(VideoModel,default = 1,verbose_name="operationId",on_delete=models.SET_DEFAULT,related_name='rel')
    ...
    startTime = models.TimeField(auto_now=False,auto_now_add=False,null=False,blank=False)
    endTime = models.TimeField(auto_now=False,auto_now_add=False,null=False,blank=False)


class FusedResult(models.Model):
    operationId = models.ForeignKey(VideoModel,default=1,verbose_name="operationId",on_delete=models.SET_DEFAULT)
    videoPath = models.CharField(max_length=200,blank=False,null=False,default="~/")
    videoName = models.CharField(max_length=100,blank=False,null=False,default="a.mp4")
    videoUrl = models.CharField(max_length=500,blank=False,null=False,default="/media/downloadable/")
    def __str__(self):
